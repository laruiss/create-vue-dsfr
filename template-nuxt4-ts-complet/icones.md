...
::: warning
La prop `ssr` de `VIcon` évite les erreurs d’hydratation dans certains contextes, mais elle ne doit pas être comprise
comme une garantie que le SVG de l’icône sera présent dans le HTML généré en SSR ou en SSG.
